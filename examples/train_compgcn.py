...
def parse_args():
    ...
    parser.add_argument("--reg", nargs="?", type=float, help="regularsation.")
    parser.add_argument("--dataset", nargs="?", type=str, help="dataset name")
    parser.add_argument("--base_dim", nargs="?", type=int, help="base dimension")
    parser.add_argument("--n_base", nargs="?", type=int, help="number of base")

    parser.add_argument("--late_dim", nargs="?", type=int, help="latent dimension")
